...
if (! defined('EE_IMPORTER_BASENAME')) {
    ...
    define('EE_IMPORTER_ADMIN', EE_IMPORTER_PATH . 'ui' . DS . 'admin' . DS . 'importer' . DS);
}
...
class EE_Importer extends EE_Addon
{
    ...
    // {
    //     // if for some reason you absolutely, positively NEED a constructor...
