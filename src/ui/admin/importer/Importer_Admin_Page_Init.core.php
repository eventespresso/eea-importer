...
class Importer_Admin_Page_Init extends EE_Admin_Page_Init
{
    ...
    {
        if (! defined('ATTENDEE_IMPORTER_PG_SLUG')) {
            ...
            define(
                'EE_ATTENDEE_IMPORTER_ADMIN_ASSETS_URL',
                EE_IMPORTER_URL . 'ui' . DS . 'admin' . DS . 'importer' . DS . 'assets' . DS
            );
            define('EE_ATTENDEE_IMPORTER_ADMIN_TEMPLATE_PATH', EE_IMPORTER_ADMIN . 'templates' . DS);
            define(
                'EE_ATTENDEE_IMPORTER_ADMIN_TEMPLATE_URL',
                EE_IMPORTER_URL . 'ui' . DS . 'admin' . DS . 'importer' . DS . 'templates' . DS
            );
        }
