...
[![Latest Release](https://img.shields.io/github/tag/eventespresso/eea-attendee-importer.svg?style=flat&label=Latest%20Release)](https://github.com/eventespresso/eea-attendee-importer/releases)
[![Travis](https://travis-ci.org/eventespresso/eea-attendee-importer.svg?branch=master)](https://travis-ci.org/eventespresso/eea-attendee-importer)
...
| **Some Links**|     |
|---- | --- |
**Support License** | Support for this add-on is not provided through this repository.  For support you can purchase a [Premium Support License](https://eventespresso.com/product/eea-attendee-importer?ee_ver=ee4&utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=premium+support+license). 
**Documentation** | [View Documentation →](https://eventespresso.com/wiki/eea-attendee-importer?utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=view+addon+documentation)
