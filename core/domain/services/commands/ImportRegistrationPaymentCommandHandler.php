 ...
 */
class ImportRegistrationPaymentCommandHandler extends CommandHandler
{
    ...
    {
        /** @var ImportRegistrationPaymentRowCommand $command */
        if (! $command instanceof ImportRegistrationPaymentRowCommand) {
