 ...
 * DTO for passing data to a TransactionFromCsvRowCommandHandler
 *
 * @package       Event Espresso
 * @author        Michael Nelson
 */
class TransactionFromCsvRowCommand extends Command implements CommandRequiresCapCheckInterface
{
