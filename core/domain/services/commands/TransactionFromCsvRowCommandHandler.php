 ...
 */
class TransactionFromCsvRowCommandHandler extends CommandHandler
{
    ...
    {
        /** @var TransactionFromCsvRowCommand $command */
        if (! $command instanceof TransactionFromCsvRowCommand) {
